# setwd("~/iata_analysis/flight_spread/src/compare_peak_times")
# orderly::orderly_develop_start(use_draft = TRUE, parameters = list(init_inf = 100))

peak_times <- readRDS("peak_times.rds")
...
all_wider$metric <- "peak_times"

# Save dataframe of the differences for later compilation
saveRDS(all_wider, "peak_time_differences.rds")
